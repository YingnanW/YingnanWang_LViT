...
class ILViT_contrast(nn.Module):
    def __init__(
        self,
        *,
        num_classes,
            ...
            for stage_ind in range(layer_depth):
                ...
                block1 = nn.Sequential(
                    CSA(
                        ...
                        kernel_size = kernel_size_b, #3-.>padding=1    kernel=5-->padding 2
                        padding=padding_b
                    ),
...
class ILViT_with_usual_net(nn.Module):
    def __init__(
        self,
        *,
        num_classes,
